...
child1.webContents.loadFile(path.resolve(__dirname, './view1.html'))
  ...
  // child2.webContents.openDevTools();
  // child2.webContents.setPosition(0, 150);
...
child3.webContents.setIgnoreMouseEvents(true)
// child2.webContents.openDevTools();
// child2.webContents.setPosition(0, 150);
...
// mainwin.removeBrowserView(child2);
  mainwin.setTopBrowserView(child3);

  console.log('mainwin', mainwin.getBrowserViews())
  // child2.webContents.hide();
    // setTimeout(() => {
    //   // mainwin.setTopBrowserView(child2);
    //     child2.setBounds({
    //       x: 0,
    //       y: 40,
    //       width: 1440, 
